	...
	<div class="action  divaction">
		...
		<div class="pages">
			<form id="claimVoucher_updateClaimVoucher_action" name="claimForm"
				enctype="multipart/form-data" action="/jboa/c/TbReimburse/add"
				method="post">
		...
		$("#AddRow")
				.click(
						function() {
							...
							tr.find("td").get(0).innerHTML = "<input  id=item"+j+" name='desc' type=hidden value="+item+" />"
									+ item;
							tr.find("td").get(1).innerHTML = "<input  id=account"+j+" name='subtotal' type=hidden value="+account+" />"
									+ account;
							...
							tr.find("td").get(3).innerHTML = "<img src=images/delete.gif width=16 height=16 id=DelRow"
									+ j + " onclick=delRow(" + j + ",this) />";
							//图片操作
							var fr = new FileReader();
							var fileEle = "<input type='file' name='imgFile' id='desc"
									+ (j + 1) + "'>";
